...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('awsome star 1', starId1, {from: user1});
    await instance.createStar('awsome star 2', starId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo(starId), 'Alpha Centauri');
});